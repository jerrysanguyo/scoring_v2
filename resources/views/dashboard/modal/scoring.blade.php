    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body py-7 px-8">
                ...
                <form id="scoreForm" method="POST" action="{{ route(Auth::user()->getRoleNames()->first() . '.scores.store') }}">
                    @csrf

                    <input type="hidden" id="scoreParticipantId" name="participant_id">
                    <input type="hidden" id="scoreCriteriaId" name="criteria_parent_id">
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary mt-3">
                            <i class="ki-duotone ki-save-2 fs-5 me-1"></i> Save Scores
                        </button>
                    </div>
                </form>
